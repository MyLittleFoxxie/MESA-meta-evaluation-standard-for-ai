...
- **Be honest about cost.** Give a realistic effort estimate per migration step. If migrating
  ...
  freezing instead.
- **Repo style applies** (`AGENTS.md`): concise academic prose, explicit assumptions, cautious
