...
(`.Codex/agents/benchmark-reviewer.md`, `.Codex/skills/review-benchmark/`) reviews
...
- **Write only under `feedback/`.** Never edit `paper.tex`, the template, or any other repo
  ...
  decides.
- **Repo style applies** (see `AGENTS.md`): concise academic prose, description separated from
