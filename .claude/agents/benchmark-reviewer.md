...
description: Use for source-grounded MESA reviews of AI benchmarks (Part A factual description, optional Part B EFPA-style ratings). Invoke when the user asks to "review", "MESA-review", "audit", or produce a `markdown/reviews/{benchmark}.md` for any benchmark, leaderboard, eval harness, suite component, or evaluator-specific implementation.
---
