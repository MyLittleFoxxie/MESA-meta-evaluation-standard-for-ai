...
Use `markdown/Papers/EFPA_Test_Review_Model_2025_Markdown.md` as the source structure, `markdown/MESA EFPA adaptation map.md` as the adaptation rationale, `markdown/MESA Part B literature synthesis.md` as the local synthesis for Part B, and `markdown/MESA EFPA template guide v4.md` as the field-level reviewer guide.
...
- [ ] Continual learning or adaptation
...
- [ ] Literature coverage: each major MESA criterion is linked to EFPA, BetterBench, Measuring what Matters, or AGI/CHC literature where relevant.
- [ ] Descriptive/evaluative separation: Part A contains no ratings and Part B contains no unsupported claims.
- [ ] Rating usability: each Part B rating has evidence, missing evidence, reviewer rationale, and interpretation caution.
...
- [ ] HLE fit or pilot fit: the template can express known issues without forcing false precision.
